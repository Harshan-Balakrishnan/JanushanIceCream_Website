  ...
  return (
    <footer className="cinematic-footer" id="footer">
      ...
      <div className="social-links" aria-label="Janushan Ice Cream social links">
        <a className="social-link" href="https://www.facebook.com/search/pages/?q=Janushan%20Ice%20Cream" target="_blank" rel="noreferrer" aria-label="Janushan Ice Cream on Facebook">
        ...
        <a className="social-link" href="https://www.instagram.com/explore/search/keyword/?q=Janushan%20Ice%20Cream" target="_blank" rel="noreferrer" aria-label="Janushan Ice Cream on Instagram">
        ...
        <a className="social-link" href="https://www.google.com/maps/search/?api=1&query=Janushan%20Cool%20Bar%20Vavuniya" target="_blank" rel="noreferrer" aria-label="Janushan Ice Cream Google reviews">
